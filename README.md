...
- **Rust** – базовые навыки, изучение языка для написания безопасных и производительных утилит  
...
- **Пробные утилиты на Rust**  
  *Эксперименты с Rust для создания небольших CLI-утилит с акцентом на безопасность и производительность*  

## 🏆 Достижения  
- Участие в хакатонах и open-source проектах  
- Работал в команде над задачами машинного обучения  
- Изучение Rust через практические задачи и эксперименты с open-source библиотеками
